...
describe('Session', ()=>{
  ...
  describe('state changes', ()=>{
    ...
    it('can transition to AT_PLAY', ()=>{
      ...
      expect(session.context).to.equal('AT_PLAY')
    })
